...
class _LazyIndexedStackState extends State<LazyIndexedStack> {
  ...
  // TODO: Implement the `_buildChildren` method to build children with their activated state.
  // Hint: Try the `List.generate` constructor again.
  ...
  Widget build(BuildContext context) {
    return IndexedStack(
      ...
      index: widget.index,
      // TODO: Call the `_buildChildren` method here.
